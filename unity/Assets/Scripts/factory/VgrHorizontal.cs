 ...
 * @description    :  This script will controll the horizontal Vgr.
 *==========================================================================================================*/
...
namespace FlexibleFischerFactory.Factory {
	public class VgrHorizontal : MonoBehaviour {
		...
		private const int _encoderMax = 3400;

		private const float _mmPerEncoder = _posMax / _encoderMax;

		void Update() {
			float horPos = _s7Comm.plcVgrHorizontalEncoder * _mmPerEncoder;

			//Move the model
			transform.localPosition = new Vector3(37.5f, -22.5f, -91f + horPos);
		}
	}
}
